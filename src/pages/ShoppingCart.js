...
function ShoppingCart() {
    ...
    return (
        <Layout>
            {carts.length === 0 ? (<Box sx={{ p: 45, textAlign: 'center', fontSize: '20px', color: '#808080' }}>Your shopping cart is empty.</Box>) : (
                <Box sx={{ flexGrow: 1 }}>
                        ...
                        <Grid item xs={6} md={3} sx={{ maxWidth: '100%' }}>
                            ...
                            <form onSubmit={onSubmitCart}>
                                <Box sx={{ display: 'flex', flexDirection: 'column', my: 1 }}>
                                    ...
                                    <TextField id="name" label="Họ và tên" value={userLogin.name} variant="outlined" sx={{ my: 1 }} />
                                    <TextField id="phone" type='tel' label="Số điện thoại" value={phone || ""} onChange={handleChangePhone} variant="outlined" sx={{ my: 1 }} />
                                    {errorPhone && <p className='errorcart'>Vui lòng nhập số điện thoại của bạn</p>}
                                    <TextField id="address" label="Địa chỉ" value={address || ""} onChange={handleChangeAddress} variant="outlined" sx={{ my: 1 }} />
                                    {errorAddress && <p className='errorcart'>Vui lòng nhập địa chỉ nhận hàng của bạn</p>}
                                </Box>
                                <Box sx={{ mt: 1 }}>
                                    <FormControl>
                                    ...
                                    {errorRadio && <p className='errorcart'>Vui lòng chọn phương thức thanh toán của bạn</p>}
                                </Box>
                                <Divider />
