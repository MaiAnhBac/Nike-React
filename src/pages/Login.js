...
function Login() {
    ...
    const [hasInput1, setHasInput1] = useState(false);
                ...
                <Grid textAlign={'center'} sx={{my: 18 }}>
                    <Paper className='paper' elevation={20} style={paperStyle}>
                        ...
                        <form onSubmit={onConfirmLogin} style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            {!hasInput && <p style={{color: 'red', marginLeft: 5, marginBottom: '6px', fontSize: '12px', textAlign: 'left'}}>{error}</p>}
                            <FormControl variant="outlined" sx={{mb: 1, mt: 0.5}}>
                             ...
                             {!hasInput1 && <p style={{color: 'red', marginLeft: 5, marginBottom: 3, fontSize: '12px', textAlign: 'left'}}>{error}</p>}
